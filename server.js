...
async function getSheets() {
  const auth = new google.auth.GoogleAuth({
    credentials: {
      ...
      private_key_id:'1fd8a91336cda25ece8f1a4984def004cf3bbd4e',
      private_key:[
        '-----BEGIN PRIVATE KEY-----',
        'MIIEvQIBADANBgkqhkiG9w0BAQEFAASCBKcwggSjAgEAAoIBAQDlJIudB387C4Vf',
        '68GoatuImRCXkExkRR3A+OPA1XiOkOEzbJ+lrlU7FOMqu7FPUE3/LbyfcWiEIWUw',
        'jTkD1dPGo3pRzOfM5BhXQ34++sU1hnRdgS7RuicKp7xI5je6Kj/ivYwvt78BnCiU',
        'fHIZ6hifPck7onea4AHy8lR6PwY5mt/EtFOdK2mbYGSYtFCo6TfJQo2NmP38bTET',
        'i0DzssZcfN3GE6xcvovi1W7R4FCK3LyrQvSENlceMHf4lEiMFRN3E29x58T+m29w',
        'hn2Ohfb/bZ4FOZWRxJvphvwJxnamRGdj3AmnYhLPnTZf6ADlrxep2Gv8i2pVECgL',
        'SapMnNunAgMBAAECggEAV8F+Qp5baLaJ1umIWkLKXu8X/qPBzej2czAesXxP1nG/',
        '/ZzNK3uvopfmRDhruI9tv5u5kGqzd17+zPBY9JIQsBNtxiQuZja457quf9o0asJa',
        'kHDoCGQ9jYQdxOF+WCrUGrczGBdL7Ibst6lNXYVc9qeICPG40rSVqoCKP+MhNC/V',
        'ly4CAW0e/FVg8Q7Q202hwWggkZJvwc40mMTni3IwTZiloJxOsjtnaqi3/cxpjYRn',
        'OWv2LRv4CoLdpewjvyWTmAJa45tlRZgKrZ8yoyO7lGaQ3lT19Ipf7kgO/MEPiVCQ',
        'PRvrgzuOZOLFLZnSJ/VLZEF/Pk6MfuZq6GidZXWq6QKBgQD2FRXtn+Jt4YPUpFeH',
        '8ejtWUo78u4Z95VQ7/2pdwGa7mkPV1l9exh9uPpYY/3CXW3YVPbwOTS+0+OQ9lHX',
        'J/HnW3CeaPipAVCBDt5WI1Vvs2eWNALevEGk1agUyRggfCWRov81jNrLdOoFjOnx',
        'fVoEJ6z70KVQfB7iDv0mbsIjswKBgQDuYLAk0dVd1NiU6DeY3gUVgEKNQSp5aP5d',
        'YVEa2CJgrzEzCfIS6JqQXv6Qv3UUUs4TzDPZCSVXzawdNjK38F5XxtZDsGig857K',
        'Iq+LyiTnYDzZxvmdmFdWLA3Zcb2aOQLHyIK9PqedhB5wX8mwCx+q4BGEEA5XJxe/',
        'jnQ2xvc+PQKBgFyaNrRDFFwxHwDoDyBTQkn+7dZ9ZmhTKNdaWGRrKil5SgPB5SU5',
        'K1A0SdD1X8rCidF8t6hSfqzI47vrVYTXvUpIuKqD6f7/RaIrTDOx/DaaloKJdAMJ',
        'aNJ0rFmWCwQ+c4zIf61RIgyqJF6OVoLPnw4tOAVS0MLm0mBTL6REzb3NAoGAbOaX',
        'EfsasscuOrjrzVaAlBYIUWfX86dXrWlsGAttiSYAIAUHJkRFeHctbQtKfYJmyvyb',
        'Iyfee4JmguHjwcx6DTe1Yy8QXZduj4HRGNe8jEeXBRa1qp2SKLfvi8s+h1pMPuEH',
        'eVVKVdep4ESia15plTLQTbjYFFCztLtrtCqpgTECgYEAr4nD73HsOz5zR2XVF2Tq',
        '7PKtY1FnCM8ktKiLQfjRFQssHU39ER1RsgcXXwEQz5dx2g/mc7bPoU5erKaGq4iP',
        'j0kSyexqMuy5lhfhYPwuHYjM175LV5SIw8b6pD2R8O7baMSmLGjVZDes+J0agfdN',
        'JhG0JSBqYusfjmnVv5T2T0k=',
        '-----END PRIVATE KEY-----'
      ].join('\n')+'\n',
